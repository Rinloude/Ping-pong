...
win = mixer.Sound('happy_wheels_victory.mp3')
...
text_win2 = font_win2.render("Победил игрок под номером 2!", 1, (255,255,255))
text_win = font_win.render("Победил игрок под номером 1!", 1, (255,255,255))
while game:
